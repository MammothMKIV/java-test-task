...
public class CreateBookDto {
    ...
    @NotNull(message = "Book author must not be blank")
    @Length(min = 1, max = 100, message = "Book author must be at least 1 character long and not longer than 100 characters")
    ...
    public CreateBookDto(String title, String description, String author, String isbn, int printYear) {
        this.title = title;
